...
runners.map(function (runner){
    return allCap.push(runner.first_name.toUpperCase())
});
...
// Problem 1
//how many T-shirt of each size the Director have to buy.

const count = runners.reduce( (tally, runner) => {
  tally[runner.shirt_size] = (tally[runner.shirt_size] || 0) + 1 ;
  return tally;
} , {})
console.log(count);
